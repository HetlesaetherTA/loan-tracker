...
-- ===========================================================================
-- SEED DATA: Populate loans and ledger for testing
-- ===========================================================================
-- 1. Insert a PENDING Loan (No ledger entries yet)
INSERT INTO loans(id, user_id, original_principal, principal, yearly_interest, due_at, payment_frequency, next_payment_at, status, description)
...
-- 2. Insert an ACTIVE Loan (With active history in the ledger)
INSERT INTO loans(id, user_id, original_principal, principal, yearly_interest, due_at, payment_frequency, next_payment_at, current_version, status, description)
...
-- 3. Insert a PAID_OFF Loan
INSERT INTO loans(id, user_id, original_principal, principal, yearly_interest, due_at, payment_frequency, next_payment_at, current_version, status, description)
  VALUES ('33333333-3333-3333-3333-333333333333', '00000000-0000-0000-0000-000000000000', 1200.0000, 0.0000, 0.12000, -- 12% interest, $0 remaining balance
